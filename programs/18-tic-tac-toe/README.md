...
## Description
A two-player console Tic Tac Toe game with a 3x3 board.
...
## Explanation
The board is a 2D char array. After every move, rows, columns and diagonals are checked for three matching symbols.
